  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          <h1 className="text-2xl sm:text-3xl font-bold tracking-tight">Personal Loans</h1>
          <p className="text-sm sm:text-base text-muted-foreground">Manage money you've borrowed or lent to others.</p>
        </div>
